	...
	<main>
		...
		<div style="width: 100%;display: flex;flex-direction: column; gap: 1em;">
				...
				<section class="dashboard-summary">
                    ...
                    <div class="stats-grid">
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-info">
                                <h3><fmt:message key="datos_personales" /></h3>
                                <p class="stat-description">
                                    ${usuarioEditar.nombre} ${usuarioEditar.apellidos}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-info">
                                <h3><fmt:message key="rol" /></h3>
                                <p class="stat-description">${usuarioEditar.rol.tipo}</p>
                            </div>
                        </div>
                        ...
                        <div class="stat-card">
                            ...
                            <div class="stat-info">
                                ...
                                <p class="stat-description"><fmt:message key="cambiar_contrasena" /></p>
                            </div>
                        </div>
                    </div>
				</section>
			...
			<div class="dashboard-container">
                            ...
                            <div class="form-section">
                                <div class="form-grid">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="dni" name="dni" value="${usuarioEditar.dni}" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="apellidos" name="apellidos" value="${usuarioEditar.apellidos}" required>
                                    </div>
                                    
                                    <!-- Teléfono -->
                                    <div class="form-group">
                                        <label for="telefono"><fmt:message key="telefono" /></label>
                                        <input type="tel" id="telefono" name="telefono" value="${usuarioEditar.telefono}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="rol" value="${usuarioEditar.rol.tipo}" readonly>
                                        <input type="hidden" name="rol_id" value="${usuarioEditar.rol.id}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-section">
                                <div class="form-grid">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="cif" name="cif" value="${usuarioEditar.centroEscolar.CIF}" required>
                                    </div>
                                    
                                    <!-- Nombre del centro -->
                                    <div class="form-group">
                                        <label for="nombreCentro"><fmt:message key="nombre_centro" /></label>
                                        <input type="text" id="nombreCentro" name="nombreCentro" value="${usuarioEditar.centroEscolar.nombre}" required>
                                    </div>
                                    
                                    <!-- Ciudad -->
                                    <div class="form-group">
                                        <label for="ciudad"><fmt:message key="ciudad" /></label>
                                        <input type="text" id="ciudad" name="ciudad" value="${usuarioEditar.centroEscolar.ciudad}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="numeroAlumnos" name="numeroAlumnos" value="${usuarioEditar.centroEscolar.numeroAlumnos}" min="0">
                                    </div>
                                </div>
                            </div>
                        </section>
                ...
                <div class="dashboard-container">
                    <section class="password-section secstyle">
                        <div class="section-header">
                ...
                <div class="dashboard-container">
                    <section class="actions-section secstyle">
                        <div class="form-actions">
                            ...
                            <a href="gestionCentros" class="btn-action btn-cancel">
