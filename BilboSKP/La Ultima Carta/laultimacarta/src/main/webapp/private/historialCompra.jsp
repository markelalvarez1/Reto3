		...
		<div
			...
			<div class="dashboard-container">
				...
				<section class="dashboard-summary">
					<h1>
						<fmt:message key="dashboard_historial_titulo" />
					</h1>
					...
					<div class="cupones-grid stats-grid">
						...
						<a href="historialCompra" class="cupones-card stat-card">
							...
							<div class="stat-info">
								...
								<div class="cupon-info">
									<p class="cupon-description">
										<fmt:message key="historial_cupon_descripcion" />
									</p>
								</div>
							</div>
						</a>
						...
						<a href="devolucion" class="cupones-card stat-card">
							...
							<div class="stat-info">
								...
								<div class="cupon-info">
									<p class="cupon-description">
										<fmt:message key="devolver_cupon" />
									</p>
								</div>
							</div>
						</a>
					...
					<div class="left-column">
						<section class="historial-compras-section secstyle">
							<div class="section-header">
								<h2>
									<fmt:message key="compras_realizadas" />
								</h2>
							...
							<div class="paginacion">
								...
								<span class="pagina-actual">1</span> <span class="separador">/</span>
