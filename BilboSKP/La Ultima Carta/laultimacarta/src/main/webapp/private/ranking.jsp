				...
				<div class="main-content">
					<div class="card">
						<div class="card-header">
							...
							<c:if test="${param.tipo == 'clases' && usuario != null && usuario.rol.id == 1}">
								<div class="action-buttons">
									<a href="reiniciarRanking" class="btn btn-primary">
										<fmt:message key="reiniciar_ranking" />
									</a>
								</div>
							</c:if>
						</div>
									...
									<c:choose>
										<c:when test="${empty rankingClases}">
											<div class="text-center">
												<p><fmt:message key="no_datos_ranking" /></p>
											</div>
										</c:when>
										<c:otherwise>
											<div class="ranking-list">
												<c:forEach items="${rankingClases}" var="item" varStatus="status">
						...
						<c:choose>
							<c:when test="${param.tipo == 'clases'}">
								...
								<p class="text-center text-sm text-muted mt-4">
									<fmt:message key="puntuacion_formula" />: (aciertos * 10) - (pistas * 2) + bonus_tiempo
								</p>
							</c:when>
							<c:otherwise>
							...
							<div class="card">
								<div class="card-header">
									<div class="card-badge">
										...
										<span><fmt:message key="informacion_ranking" /></span>
									</div>
									<h3 class="card-title"><fmt:message key="como_funciona_ranking" /></h3>
								</div>

								<div class="card-content">
									<p><fmt:message key="ranking_descripcion1" /></p>
									<p><fmt:message key="ranking_descripcion2" /></p>
									<p><fmt:message key="ranking_descripcion3" /></p>
								</div>
							</div>
							...
							<div class="card mt-4">
								<div class="card-header">
									<div class="card-badge">
										...
										<span><fmt:message key="reinicio_ranking" /></span>
									</div>
								</div>

								<div class="card-content">
									<p><fmt:message key="reinicio_info1" /></p>
									<p><fmt:message key="reinicio_info2" /></p>
									<ul>
