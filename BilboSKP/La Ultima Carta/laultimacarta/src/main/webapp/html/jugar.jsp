			...
			<div class="max-width">
					...
					<div class="card">
						<div class="card-header">
							<div class="card-badge">
								<span class="icon icon-file"></span> <span><fmt:message
										key="historia_interactiva" /></span>
							</div>
							<h2 class="card-title">
								<fmt:message key="historia_marcos" />
							</h2>
							<p class="card-description">
								<fmt:message key="descripcion_historia" />
							</p>
						</div>
						<div class="card-content">
							<div class="section">
								<h3 class="section-title">
									<fmt:message key="sinopsis" />
								</h3>
							...
							<div style="margin-bottom: 1.5rem;">
								<h3 class="section-title" style="margin-bottom: 0.75rem;">
									<fmt:message key="dos_finales" />
								</h3>
								<div class="endings-grid">
									<div class="ending-card">
										<span class="badge badge-green"><fmt:message
												key="final_a" /></span>
										<p class="section-content">
									...
									<div class="ending-card">
										<span class="badge badge-amber"><fmt:message
												key="final_b" /></span>
										<p class="section-content">
							...
							<div class="section">
								<h3 class="section-title">
									<fmt:message key="informacion_archivo" />
								</h3>
								<ul class="info-list">
									<li><span class="info-label"><fmt:message
												key="formato" />:</span> <span><fmt:message
												key="formato_jar" /></span></li>
									<li><span class="info-label"><fmt:message
												key="tamano" />:</span> <span><fmt:message
												key="tamano_valor" /></span></li>
									<li><span class="info-label"><fmt:message
												key="version" />:</span> <span><fmt:message
												key="version_valor" /></span></li>
									<li><span class="info-label"><fmt:message
												key="ultima_actualizacion" />:</span> <span><fmt:message
												key="fecha_actualizacion" /></span></li>
								</ul>
							</div>
						</div>
					...
					<div class="card">
						<div class="card-header" style="padding: 1rem 1.5rem;">
							<h3 class="card-title" style="font-size: 1.125rem;">
								<fmt:message key="instrucciones" />
							</h3>
						</div>
						<div class="card-content">
							<div class="instruction-step">
								<p>
									<fmt:message key="paso_1" />
								</p>
							</div>
							<div class="instruction-step">
								<p>
									<fmt:message key="paso_2" />
								</p>
							</div>
							<div class="instruction-step">
								<p>
									<fmt:message key="paso_3" />
								</p>
							</div>
							<div class="instruction-step">
								<p>
									<fmt:message key="paso_4" />
								</p>
							</div>
						</div>
					</div>
				...
				<div class="card">
					<div class="card-header">
						...
						<p class="card-description">
							<fmt:message key="verifica_requisitos" />
						</p>
					</div>
					<div class="card-content">
						<div class="tabs">
							...
							<div id="minimos" class="tab-content active">
								<table>
									...
									<tbody>
										<tr>
											<td class="font-medium"><fmt:message
													key="sistema_operativo" /></td>
