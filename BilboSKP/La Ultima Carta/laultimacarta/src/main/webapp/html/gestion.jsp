        ...
        <div class="container dashboard-container">
		    ...
		    <div class="top-row">
		        ...
		        <div class="block profile-block">
		            <h2><fmt:message key="perfil_usuario" /></h2>
		            <div class="profile-info">
		                <div class="profile-avatar">
		                    <img src="https://via.placeholder.com/200" alt="<fmt:message key='avatar_usuario' />">
		                </div>
		                <h3><fmt:message key="nombre_usuario" /></h3>
		                <div class="level-badge"><fmt:message key="nivel_usuario" /></div>
		            </div>
		            
		            <div class="profile-stats">
		                <div class="stat-item">
		                    <p class="stat-label"><fmt:message key="puntos" /></p>
		                    <p class="stat-value">1250</p>
		                </div>
		                <div class="stat-item">
		                    <p class="stat-label"><fmt:message key="partidas" /></p>
		                    <p class="stat-value">28</p>
		                </div>
		                <div class="stat-item full-width">
		                    <p class="stat-label"><fmt:message key="victorias" /></p>
		        ...
		        <div class="block ranking-block">
		            <h2><fmt:message key="mini_ranking" /></h2>
		            <div class="ranking-list">
		                <div class="ranking-item">
		                    <div class="ranking-position">
		                        ...
		                        <div>
		                            <p class="player-name"><fmt:message key="jugador_1_nombre" /></p>
		                            <p class="player-points"><fmt:message key="jugador_1_puntos" /></p>
		                        </div>
		                    </div>
		                ...
		                <div class="ranking-item">
		                    <div class="ranking-position">
		                        ...
		                        <div>
		                            <p class="player-name"><fmt:message key="jugador_2_nombre" /></p>
		                            <p class="player-points"><fmt:message key="jugador_2_puntos" /></p>
		                        </div>
		                    </div>
		                ...
		                <div class="ranking-item">
		                    <div class="ranking-position">
		                        ...
		                        <div>
		                            <p class="player-name"><fmt:message key="jugador_3_nombre" /></p>
		                            <p class="player-points"><fmt:message key="jugador_3_puntos" /></p>
		                        </div>
		                    </div>
		                ...
		                <div class="ranking-item current-user">
		                    <div class="ranking-position">
		                        ...
		                        <div>
		                            <p class="player-name"><fmt:message key="nombre_usuario" /></p>
		                            <p class="player-points"><fmt:message key="usuario_puntos" /></p>
		                        </div>
		                    </div>
		                ...
		                <div class="view-all">
		                    <a href="ranking.html"><fmt:message key="ver_ranking_completo" /></a>
		                </div>
		            </div>
		        </div>
		    </div>
		    ...
		    <div class="block options-block">
		        <h2><fmt:message key="opciones" /></h2>
		        <div class="options-grid">
		            <!-- Opción: Organizar Partida -->
		            <div class="option-card blue-gradient">
		                <h3><fmt:message key="organizar_partida" /></h3>
		                <div class="option-features">
		                    <div class="option-feature">
		                        ...
		                        <div class="feature-text">
		                            <h4><fmt:message key="crear_partida" /></h4>
		                            <p><fmt:message key="crear_partida_desc" /></p>
		                        </div>
		                    </div>
		                    <div class="option-feature">
		                        <div class="feature-icon blue">
		                        ...
		                        <div class="feature-text">
		                            <h4><fmt:message key="unirse_partida" /></h4>
		                            <p><fmt:message key="unirse_partida_desc" /></p>
		                        </div>
		                    </div>
		                    <button class="action-button blue">
		                        <a href="gestion.html"><fmt:message key="gestionar_partidas" /></a>
		                    </button>
		                </div>
		            </div>
		            ...
		            <div class="option-card amber-gradient">
		                <h3><fmt:message key="adquirir_cupones" /></h3>
		                <div class="option-features">
		                    <div class="option-feature">
		                        ...
		                        <div class="feature-text">
		                            <h4><fmt:message key="comprar_cupones" /></h4>
		                            <p><fmt:message key="comprar_cupones_desc" /></p>
		                        </div>
		                    </div>
		                    <div class="option-feature">
		                        <div class="feature-icon amber">
		                        ...
		                        <div class="feature-text">
		                            <h4><fmt:message key="canjear_premios" /></h4>
		                            <p><fmt:message key="canjear_premios_desc" /></p>
		                        </div>
		                    </div>
