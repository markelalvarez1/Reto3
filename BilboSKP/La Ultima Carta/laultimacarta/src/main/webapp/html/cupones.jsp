        ...
        <div class="container coupons-container">
            ...
            <div class="sidebar">
	            <nav>
	                <ul>
	                    <li>
	                        <a href="menuperfil.jsp" class="sidebar-link active">
            ...
            <div class="coupons-content">
			    <div class="page-header">
			        <h1><fmt:message key="cupones_titulo" /></h1>
			        <p><fmt:message key="cupones_subtitulo" /></p>
			    </div>
			    ...
			    <div class="coupons-summary">
			        <div class="summary-card">
			            ...
			            <div class="summary-info">
			                <h3><fmt:message key="cupones_puntos" /></h3>
			        ...
			        <div class="summary-card">
			            ...
			            <div class="summary-info">
			                <h3><fmt:message key="cupones_activos" /></h3>
			        ...
			        <div class="summary-card">
			            ...
			            <div class="summary-info">
			                <h3><fmt:message key="cupones_canjeados" /></h3>
			    ...
			    <div class="block available-coupons">
			        <div class="block-header">
			            <h2><fmt:message key="cupones_disponibles" /></h2>
			        ...
			        <div class="coupons-grid">
			            ...
			            <div class="coupon-card featured">
			                <div class="coupon-header">
			                    <h3><fmt:message key="cupon_1_titulo" /></h3>
			                    <div class="coupon-points">300 pts</div>
			                </div>
			                <div class="coupon-content">
			                    <p><fmt:message key="cupon_1_descripcion" /></p>
			                    <div class="coupon-details">
			                        <div class="coupon-detail">
			                            <i class='bx bx-calendar'></i>
			                            <span><fmt:message key="cupon_1_valido_hasta" /></span>
			                        </div>
			                        <div class="coupon-detail">
			                            <i class='bx bx-info-circle'></i>
			                            <span><fmt:message key="cupon_1_tipo" /></span>
			                        </div>
			                    </div>
			                </div>
			                <div class="coupon-footer">
			                    <button class="primary-button"><fmt:message key="cupon_obtener" /></button>
			                </div>
			            </div>
			            ...
			            <div class="coupon-card">
			                <div class="coupon-header">
			                    <h3><fmt:message key="cupon_5_titulo" /></h3>
			                    <div class="coupon-points">1200 pts</div>
			                </div>
			                <div class="coupon-content">
			                    <p><fmt:message key="cupon_5_descripcion" /></p>
			                    <div class="coupon-details">
			                        <div class="coupon-detail">
			                            <i class='bx bx-calendar'></i>
			                            <span><fmt:message key="cupon_5_valido_hasta" /></span>
			                        </div>
			                        <div class="coupon-detail">
			                            <i class='bx bx-package'></i>
			                            <span><fmt:message key="cupon_5_tipo" /></span>
			                        </div>
			                    </div>
			                </div>
			                <div class="coupon-footer">
			                    <button class="primary-button"><fmt:message key="cupon_obtener_paquete" /></button>
			                </div>
			            </div>
			            ...
			            <div class="coupon-card">
			                <div class="coupon-header">
			                    <h3><fmt:message key="cupon_15_titulo" /></h3>
			                    <div class="coupon-points">3000 pts</div>
			                </div>
			                <div class="coupon-content">
			                    <p><fmt:message key="cupon_15_descripcion" /></p>
			                    <div class="coupon-details">
			                        <div class="coupon-detail">
			                            <i class='bx bx-calendar'></i>
			                            <span><fmt:message key="cupon_15_valido_hasta" /></span>
			                        </div>
			                        <div class="coupon-detail">
			                            <i class='bx bx-package'></i>
			                            <span><fmt:message key="cupon_15_tipo" /></span>
			                        </div>
			                    </div>
			                </div>
			                <div class="coupon-footer">
			    ...
			    <div class="block my-coupons">
			        <h2><fmt:message key="miscupones_titulo" /></h2>
			
			        <div class="tabs-header">
			            <button class="tab-btn active" data-tab="active"><fmt:message key="miscupones_activos" /></button>
			            <button class="tab-btn" data-tab="used"><fmt:message key="miscupones_usados" /></button>
			        </div>
			            ...
			            <div class="my-coupons-list">
			                <div class="my-coupon-item">
			                    <div class="coupon-left">
			                        <div class="coupon-icon"><i class='bx bx-ticket'></i></div>
			                        <div class="coupon-info">
			                            <h3><fmt:message key="micupon_15_titulo" /></h3>
			                            <div class="coupon-meta">
			                                <span><i class='bx bx-calendar'></i> <fmt:message key="micupon_15_valido_hasta" /></span>
			                                <span><i class='bx bx-info-circle'></i> <fmt:message key="micupon_15_tipo" /></span>
			                            </div>
			                        </div>
			                    </div>
			                ...
			                <div class="my-coupon-item">
			                    <div class="coupon-left">
			                        <div class="coupon-icon"><i class='bx bx-package'></i></div>
			                        <div class="coupon-info">
			                            <h3><fmt:message key="micupon_10_titulo" /></h3>
			                            <div class="coupon-meta">
			                                <span><i class='bx bx-calendar'></i> <fmt:message key="micupon_10_valido_hasta" /></span>
			                                <span><i class='bx bx-info-circle'></i> <fmt:message key="micupon_10_restantes" /></span>
			                            </div>
			                        </div>
			                    </div>
			                    <div class="coupon-actions">
			                ...
			                <div class="my-coupon-item used">
			                    <div class="coupon-left">
			                        ...
			                        <div class="coupon-info">
			                            <h3><fmt:message key="micupon_10_titulo" /></h3>
			                            <div class="coupon-meta">
			                                <span><i class='bx bx-calendar'></i> <fmt:message key="micupon_10_usado" /></span>
			                                <span><i class='bx bx-info-circle'></i> <fmt:message key="micupon_10_canjeado" /></span>
			                            </div>
			                        </div>
			                    </div>
			                    <div class="coupon-status">
			                        <span class="status-badge used"><fmt:message key="micupon_estado_usado" /></span>
			                    </div>
			                </div>
			                ...
			                <div class="my-coupon-item used">
			                    <div class="coupon-left">
			                        ...
			                        <div class="coupon-info">
			                            <h3><fmt:message key="micupon_15_titulo" /></h3>
			                            <div class="coupon-meta">
			                                <span><i class='bx bx-calendar'></i> <fmt:message key="micupon_15_usado" /></span>
			                            </div>
			                        </div>
			                    </div>
			                    <div class="coupon-status">
			    ...
			    <div class="block coupons-info">
			        <h2><fmt:message key="info_titulo" /></h2>
			
			        <div class="info-steps">
			            <div class="info-step">
			                <div class="step-number">1</div>
			                <div class="step-content">
			                    <h3><fmt:message key="info_paso1_titulo" /></h3>
			                    <p><fmt:message key="info_paso1_desc" /></p>
			                </div>
			            </div>
			            ...
			            <div class="info-step">
			                ...
			                <div class="step-content">
			                    <h3><fmt:message key="info_paso2_titulo" /></h3>
			                    <p><fmt:message key="info_paso2_desc" /></p>
			                </div>
			            </div>
			            ...
			            <div class="info-step">
			                ...
			                <div class="step-content">
			                    <h3><fmt:message key="info_paso3_titulo" /></h3>
			                    <p><fmt:message key="info_paso3_desc" /></p>
			                </div>
			            </div>
			        </div>
			        ...
			        <div class="info-notes">
			            <div class="info-note">
			                <i class='bx bx-info-circle'></i>
			                <p><fmt:message key="info_nota1" /></p>
			            </div>
			            <div class="info-note">
			                <i class='bx bx-info-circle'></i>
			                <p><fmt:message key="info_nota2" /></p>
			            </div>
			            <div class="info-note">
			                <i class='bx bx-info-circle'></i>
			                <p><fmt:message key="info_nota3" /></p>
			            </div>
			            <div class="info-note">
			                <i class='bx bx-info-circle'></i>
			                <p><fmt:message key="info_nota4" /></p>
			            </div>
			        </div>
			    </div>
			</div>
