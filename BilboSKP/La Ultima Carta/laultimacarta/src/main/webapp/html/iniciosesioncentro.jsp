...
<body>
    ...
    <div class="container">
        <div class="form-container">
            <h1><fmt:message key="inicio_sesion_colegio" /></h1>

            <div class="form-content">
                <div id="individual-form" class="form-fields">
                    <div class="form-group">
                        <label for="school-cif"><fmt:message key="etiqueta_cif" /></label>
                        <input type="text" id="school-cif" name="school-cif" placeholder="<fmt:message key='placeholder_cif' />">
                    </div>

                    <div class="form-group">
                        <label for="school-username"><fmt:message key="etiqueta_usuario_admin" /></label>
                        <input type="text" id="school-username" name="school-username" placeholder="<fmt:message key='placeholder_usuario_admin' />">
                    </div>

                    <div class="form-group">
                        <label for="school-password"><fmt:message key="etiqueta_contrasena" /></label>
                        <input type="password" id="school-password" name="school-password" placeholder="<fmt:message key='placeholder_contrasena' />">
                    </div>
