...
<body>
      ...
      <section class="dashboard-summary">
        ...
        <div class="cupones-grid stats-grid">
          ...
          <div class="cupones-card stat-card">
            ...
            <div class="stat-info">
              <h3><fmt:message key="cupones_disponibles" /></h3>
              <div class="cupones-list">
                <c:forEach var="cupon" items="${cuponesDisponibles}" varStatus="status">
                ...
                <c:if test="${empty cuponesDisponibles}">
                  <div class="no-cupones">
                    <p><fmt:message key="no_cupones_disponibles" /></p>
                  </div>
                </c:if>
              </div>
            </div>
      ...
      <div class="content-container">
        ...
        <div class="left-column">
          ...
          <section class="compra-cupones-section">
            <div class="section-header">
              <h2><fmt:message key="comprar_cupones" /></h2>
            ...
            <div class="purchase-card">
              ...
              <div class="cupon-fijo-info">
                <h3><fmt:message key="nombre_cupon" /></h3>
                <p class="cupon-description"><fmt:message key="descripcion_cupon" /></p>
                <p class="cupon-precio-fijo" data-price="2.50">2,50 &#x20AC; / <fmt:message key="unidad" /></p>
              </div>
              ...
              <form action="cupones" method="post" class="purchase-form">
                ...
                <div class="precio-total">
                  <p><fmt:message key="precio_total" />: <span id="precioTotal">2,50</span> &#x20AC;</p>
                </div>
        ...
        <div class="right-column">
          ...
          <section class="carrito-compra">
            <div class="section-header">
              <h2><fmt:message key="carrito_compra" /></h2>
              <div class="section-divider"></div>
            </div>
            ...
            <div class="carrito-items">
              <c:if test="${not empty cantidad}">
                <div class="carrito-item">
                  <div class="item-info">
                    <h3>cupon</h3>
                    <p class="item-cantidad"><fmt:message key="cantidad" />: ${cantidad}</p>
                  </div>
            ...
            <div class="carrito-resumen">
              <div class="carrito-total">
                <p><fmt:message key="total" />: <span>${cantidad * precio}</span> &#x20AC;</p>
              </div>
              <form action="procesarCompra" method="post">
                <button type="submit" class="btn-comprar" ${empty cantidad ? 'disabled' : ''}>
  ...
  <script>
    ...
    const precioUnitario = parseFloat(document.querySelector('.cupon-precio-fijo').dataset.price);
