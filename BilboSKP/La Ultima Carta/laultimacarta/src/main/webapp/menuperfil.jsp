	...
	<main>
		<div class="container profile-container">
			...
			<div class="sidebar">
				<nav>
					<ul>
						<li><a href="#" class="sidebar-link active"> <i
								class='bx bx-user'></i> <span><fmt:message
			...
			<div class="profile-content">
				<div class="page-header">
					...
					<p>
						<fmt:message key="gestiona_info_preferencias" />
					</p>
				</div>
						...
						<div class="achievements-grid">
							<div class="achievement-card">
								...
								<div class="achievement-info">
									<h3>
										<fmt:message key="primer_victoria" />
									</h3>
									<p>
							...
							<div class="achievement-card">
								...
								<div class="achievement-info">
									<h3>
										<fmt:message key="campeon" />
									</h3>
									<p>
										<fmt:message key="gana_20_partidas" />
									</p>
				...
				<div class="profile-tabs">
					<div class="tabs-header">
						<button class="tab-btn active" data-tab="history">
							<fmt:message key="historial" />
						</button>
						<button class="tab-btn" data-tab="settings">
							<fmt:message key="configuracion" />
						</button>
					</div>
					...
					<div class="tab-content active" id="history-tab">
						<div class="block history-block">
							<h2>
								<fmt:message key="historial_partidas" />
							</h2>
							...
							<div class="history-list">
								<div class="history-item">
									...
									<div class="history-details">
										<div class="history-header">
											...
											<span class="history-result win"><fmt:message
													key="victoria" /></span>
										</div>
										<div class="history-info">
											...
											<p>
												<i class='bx bx-group'></i> 8
												<fmt:message key="jugadores" />
											</p>
											<p>
												<i class='bx bx-plus-circle'></i> 150
												<fmt:message key="puntos" />
											</p>
										</div>
									</div>
								...
								<div class="history-item">
									...
									<div class="history-details">
										<div class="history-header">
											...
											<span class="history-result loss"><fmt:message
													key="derrota" /></span>
										</div>
										<div class="history-info">
											<p>
												<i class='bx bx-time'></i> 17:30 - 19:00
											</p>
											<p>
												<i class='bx bx-group'></i> 4
												<fmt:message key="jugadores" />
											</p>
											<p>
												<i class='bx bx-minus-circle'></i> 25
												<fmt:message key="puntos" />
											</p>
										</div>
									</div>
								...
								<div class="history-item">
									<div class="history-date">
										<span class="day">05</span> <span class="month">JUN</span>
									</div>
									<div class="history-details">
										<div class="history-header">
											<h3>
												<fmt:message key="competencia_semanal" />
											</h3>
											<span class="history-result win"><fmt:message
													key="victoria" /></span>
										</div>
										<div class="history-info">
											<p>
												<i class='bx bx-time'></i> 19:00 - 21:30
											</p>
											<p>
												<i class='bx bx-group'></i> 6
												<fmt:message key="jugadores" />
											</p>
											<p>
												<i class='bx bx-plus-circle'></i> 120
												<fmt:message key="puntos" />
											</p>
										</div>
									</div>
							...
							<div class="view-more">
								<button class="view-more-btn">
									<fmt:message key="cargar_mas_partidas" />
								</button>
							</div>
						</div>
					</div>
					...
					<div class="tab-content" id="settings-tab">
						<div class="block settings-block">
							<h2>
								<fmt:message key="configuracion_cuenta" />
							</h2>

							<div class="settings-sections">
								<div class="settings-section">
									<h3>
										<fmt:message key="informacion_personal" />
									</h3>

									<form class="settings-form">
										<div class="form-group">
											<label for="full-name"><fmt:message
													key="nombre_completo" /></label> <input type="text" id="full-name"
										...
										<div class="form-row">
											<div class="form-group">
												<label for="username"><fmt:message
														key="nombre_usuario" /></label> <input type="text" id="username"
													value="carlos_r">
											</div>

											<div class="form-group">
												<label for="email"><fmt:message
														key="correo_electronico" /></label> <input type="email"
													id="email" value="carlos@ejemplo.com">
											</div>
										</div>

										<div class="form-group">
											<label for="bio"><fmt:message key="biografia" /></label>
											<textarea id="bio" rows="3"><fmt:message
													key="bio_usuario" /></textarea>
										</div>
									</form>
								</div>
									...
									<div class="settings-options">
										<div class="settings-option">
											<div class="option-info">
												<h4>
													<fmt:message key="notificaciones_correo" />
												</h4>
												<p>
													<fmt:message key="recibir_notificaciones_eventos" />
												</p>
											</div>
										...
										<div class="settings-option">
											<div class="option-info">
												<h4>
													<fmt:message key="perfil_publico" />
												</h4>
												<p>
													<fmt:message key="permitir_ver_perfil" />
												</p>
											</div>
											<label class="toggle"> <input type="checkbox" checked>
												<span class="toggle-slider"></span>
										...
										<div class="settings-option">
											<div class="option-info">
												<h4>
													<fmt:message key="mostrar_estado_online" />
												</h4>
												<p>
													<fmt:message key="mostrar_conectado" />
												</p>
											</div>
